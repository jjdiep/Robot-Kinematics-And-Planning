...
robot.joints.cpu_joint.origin = {xyz: [0,0.085,0.025], rpy: [-Math.PI/2,0,0]};
...
robot.joints.base_laser_joint.origin = {xyz: [0,0.07,0], rpy: [0,0,0]};
...
robot.joints.upper_base_joint.origin = {xyz: [0,0.07,0], rpy: [0,0,0]};
...
robot.joints.torso_joint.origin = {xyz: [0,0.10,0], rpy: [0,0,0]};
robot.joints.torso_joint.axis = [0.0,1,0];
...
robot.joints.head_pan_servo.origin = {xyz: [0,0.225,0], rpy: [0,0,0]};
robot.joints.head_pan_servo.axis = [0.0,0,1];
...
robot.joints.head_pan_joint.origin = {xyz: [0,0.045,0], rpy: [0,0,0]};
robot.joints.head_pan_joint.axis = [0.0,1,0];
...
robot.joints.head_tilt_joint.origin = {xyz: [0,0.04,0], rpy: [0,0,0]};
robot.joints.head_tilt_joint.axis = [0.0,0,1];
...
robot.joints.neck_joint.origin = {xyz: [0.05,0.015,0], rpy: [0,0,0]};
robot.joints.neck_joint.axis = [0.0,1,0];
...
robot.joints.antenna_joint.origin = {xyz: [0.0,0.065,-0.025], rpy: [0,0,0]};
robot.joints.antenna_joint.axis = [0.0,1,0];
...
robot.joints.left_shoulder_joint.origin = {xyz: [0.0,0.165,0.055], rpy: [0,0,0]};
robot.joints.left_shoulder_joint.axis = [0.0,0,1];
...
robot.joints.right_shoulder_joint.origin = {xyz: [0.0,0.165,-0.055], rpy: [0,0,0]};
robot.joints.right_shoulder_joint.axis = [0.0,0,-1];
...
robot.joints.left_shoulder_forward_joint.origin = {xyz: [0.0,0,0.025], rpy: [0,0,0]};
robot.joints.left_shoulder_forward_joint.axis = [0.0,1,0];
...
robot.joints.right_shoulder_forward_joint.origin = {xyz: [0.0,0,-0.025], rpy: [0,0,0]};
robot.joints.right_shoulder_forward_joint.axis = [0.0,1,0];
...
robot.joints.left_shoulder_up_joint.origin = {xyz: [0,-0.01,0.04], rpy: [0,-0.707,0]};
robot.joints.left_shoulder_up_joint.axis = [0.0,0,1];
...
robot.joints.right_shoulder_up_joint.origin = {xyz: [0,-0.01,-0.04], rpy: [0,-0.707,0]};
robot.joints.right_shoulder_up_joint.axis = [0.0,0,1];
...
robot.joints.left_upper_arm_joint.origin = {xyz: [0,-0.05,0], rpy: [0,0,0]};
robot.joints.left_upper_arm_joint.axis = [0.0,0,1];
...
robot.joints.right_upper_arm_joint.origin = {xyz: [0,-0.05,0], rpy: [0,0,0]};
robot.joints.right_upper_arm_joint.axis = [0.0,0,1];
...
robot.joints.left_elbow_joint.origin = {xyz: [-0.005,-0.05,0], rpy: [0,0,0]};
robot.joints.left_elbow_joint.axis = [0.0,0,1];
...
robot.joints.right_elbow_joint.origin = {xyz: [-0.005,-0.05,0], rpy: [0,0,0]};
robot.joints.right_elbow_joint.axis = [0.0,0,1];
...
robot.joints.left_lower_arm_joint.origin = {xyz: [0,-0.08,0], rpy: [0,0,0]};
robot.joints.left_lower_arm_joint.axis = [0.0,0,1];
...
robot.joints.right_lower_arm_joint.origin = {xyz: [0,-0.08,0], rpy: [0,0,0]};
robot.joints.right_lower_arm_joint.axis = [0.0,0,1];
...
robot.joints.left_wrist_joint.origin = {xyz: [0,-0.05,0], rpy: [0,0,0]};
...
robot.joints.right_wrist_joint.origin = {xyz: [0,-0.05,0], rpy: [0,0,0]};
...
robot.joints.left_hand_joint.origin = {xyz: [0,-0.055,0], rpy: [0,0,0]};
...
robot.joints.right_hand_joint.origin = {xyz: [0,-0.055,0], rpy: [0,0,0]};
