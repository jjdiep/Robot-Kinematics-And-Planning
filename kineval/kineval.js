...
kineval.initParameters = function initParameters() {
    ...
    f_turnOfEasterEgg = true; // enabling my robot dance (which was done on Fetch) and turning off fetch easter egg in case per Anthony's suggestion on Slack.
    if (robot.name === 'fetch' && f_turnOfEasterEgg) { // FSM dance implemented on Fetch robot
